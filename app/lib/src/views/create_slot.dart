...
class _CreateSlotPageState extends State<CreateSlotPage>
  ...
  Widget _routeDropDownList() {
    return DropdownButton<String>(
        ...
        hint: routes.length == 0 || selectedRoute == null
  ...
  Widget _dayDropDownList() {
    return DropdownButton<String>(
        ...
        hint: days.length == 0 || selectedDay == null
            ? Text("Please choose a day")
            : Text(days
                .firstWhere((i) => i.dayId == selectedDay)
                .toString()),
        onChanged: (newVal) {
          setState(() {
            selectedDay = newVal;
  ...
  Widget _kombiDropDownList() {
    return DropdownButton<String>(
        ...
        hint: kombis.length == 0 || selectedKombi == null
  ...
  Widget _kombiWrapper() {
    return FutureBuilder<List<Kombi>>(
        ...
        builder:
            (BuildContext context, AsyncSnapshot<List<Kombi>> snapshot) {
          switch (snapshot.connectionState) {
            case ConnectionState.none:
              return new Text('Press button to start');
            case ConnectionState.waiting:
