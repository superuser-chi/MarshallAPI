...
class CreateKombiPage extends StatefulWidget {
  const CreateKombiPage({
    Key key,
  }) : super(key: key);

  @override
  _CreateKombiPageState createState() => _CreateKombiPageState();
}

class _CreateKombiPageState extends State<CreateKombiPage>
    ...
    return GestureDetector(
      onTap: () async {
        if (_formPageKey.currentState.validate()) {
          ...
          try {
            await addKombi(userId: selectedUser,plate: _kombiPlate.text);
  ...
  Widget _userDropDownList() {
    return DropdownButton<String>(
        ...
        hint: selectedUser == null
            ...
            : Text(users
                .firstWhere((i) => i.id == selectedUser)
                .toString()),
        onChanged: (newVal) {
          setState(() {
            selectedUser = newVal;
